...
image_path = "/data/cx/datasets/fujian_gis_data/val/images/val_0_471.jpg"
mask_path = "/data/cx/datasets/fujian_gis_data/val/labels/val_0_471.jpg"
...
plt.show()
print(cal_np_f1_score(mask.flatten(), logits.flatten()))
