...
class RaftTileDataset(Dataset):
    def __init__(self, filename, conf_loader: YamlConfigLoader, mode="train"):
        ...
        self.pad_h = (self.tile_size - self.overlap_size) - (self.h - self.overlap_size) % (
                    self.tile_size - self.overlap_size)
        self.pad_w = (self.tile_size - self.overlap_size) - (self.h - self.overlap_size) % (
                    self.tile_size - self.overlap_size)
